...
- Kho ẩn được mã hóa cục bộ bằng Web Crypto và lưu trong `chrome.storage.local`; mật khẩu không được lưu dạng văn bản. Nếu quên mật khẩu, Bookmark Lens không thể khôi phục dữ liệu ẩn.
